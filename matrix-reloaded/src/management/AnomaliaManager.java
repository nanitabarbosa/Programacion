...
public class AnomaliaManager {
    ...
    public void contarAnomalias() {
        // Contar el número total de anomalías
        System.out.println("El total de anomalias es: " + anomalias.size());
    }
    ...
    public void mostrarMenu() {
        ...
        while (continuar) {
            ...
            System.out.println("3. Total Anomalías");
